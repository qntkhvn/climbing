...
\begin{enumerate}[a.]
\item Chemistry --- Use the ``APA'' option as \verb"\documentclass[APA]{WileyNJD-v2.cls}"
...
\begin{flushleft}
\begin{enumerate}[a.]
\item LATO1COL--- For LATO font large one column layout use the ``LATO1COL'' option as \verb"\documentclass[APA,LATO1COL]{WileyNJD-v2}"
\item LATO2COL--- For LATO font large two column layout use the ``LATO2COL'' option as \verb"\documentclass[APA,LATO2COL]{WileyNJD-v2}"
\item LATOSMALL--- For LATO font small layout use the ``LATOSMALL'' option as \verb"\documentclass[APA,LATOSMALL]{WileyNJD-v2}"
\end{enumerate}
\end{flushleft}
