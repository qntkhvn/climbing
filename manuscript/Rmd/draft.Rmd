...
Soccer points: @haugen2008

Cross country scoring: @hammond2007, @boudreau2018

Decathlon scoring: @westera2006
...
```{r, fig.cap = "Kendall's rank correlations - 2018 World Championship, Men's and Women's Qualifications", fig.height=8, fig.width=6}
mcor <- mq %>% 
...
All of the materials related to this research are publicly available on GitHub at \newline https://github.com/qntkhvn/climbing.