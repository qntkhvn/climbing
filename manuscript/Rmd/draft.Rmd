...
Some individual sports such as the decathlon and heptathlon rely on a sum of scores from individual events, however, these scores are not determined based on the rank of a competitior.  
