...
Regarding the finals, a climber is very likely to finish in the top 3 and hence earn a medal if they win the first event (83.03% chance) or any event (85.01% chance). Furthermore, according to our final simulations, in order to obtain a climbing medal, the average scores that put an athlete in position to receive gold, silver, and bronze medals are 9.6748, 20.4143, and 33.2648, respectively (see Table 3). 
