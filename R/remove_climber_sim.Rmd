...
remove_c5 <- lapply(5:20, function(x) replicate(100, displace_climber(nsim = 100, drop_rank = 5, nc = x)))
...
remove_c5_df <- lapply(5:20
  ...
  do.call(rbind, .)
#save(remove_c5_df, "R/remove_c5_sims.rdata")
```
